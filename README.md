...
- **Home** → Hero landing section with branding
- **Books** → Collection of aesthetic book cards
- **Flowers** → Floral shop showcase
...
This project was built for **web development internship practice** to demonstrate:
- UI/UX design skills  
...
- 🌸 Floating floral background effects  

---

## 👩‍💻 Author

Created as a frontend internship project to showcase modern aesthetic web design skills.
